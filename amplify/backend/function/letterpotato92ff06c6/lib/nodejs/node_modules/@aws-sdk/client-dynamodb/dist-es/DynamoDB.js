...
var DynamoDB = (function (_super) {
    ...
    DynamoDB.prototype.describeImport = function (args, optionsOrCb, cb) {
    ...
    DynamoDB.prototype.importTable = function (args, optionsOrCb, cb) {
        var command = new ImportTableCommand(args);
        if (typeof optionsOrCb === "function") {
            this.send(command, optionsOrCb);
        }
        else if (typeof cb === "function") {
    ...
    DynamoDB.prototype.listImports = function (args, optionsOrCb, cb) {
